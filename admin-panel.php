...
<head>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i> SMART HOSPITAL </a>
    ...
    <style>
      .bg-primary {
        background: -webkit-linear-gradient(left, #CC7A8B, #000000);
      }
...
<body style="padding-top:50px;">
  ...
  <div class="container-fluid" style="margin-top:50px;">
    <h3 style="margin-left: 40%;  padding-bottom: 20px; font-family: 'Verdana', sans-serif;"> Welcome &nbsp<?php echo $username ?>
    </h3>
    <div class="row">
