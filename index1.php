...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left,#CC7A8B, #000000); background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">

      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'Verdana', sans-serif;"><h4><i class="fa fa-hospital-o" aria-hidden="true"></i>&nbsp SMART HEALTHCARE</h4></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="index.php" style="color: white;font-family: 'Verdana', sans-serif;"><h6>HOME</h6></a>
          </li>
  
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="services.html" style="color: white;font-family: 'Verdana', sans-serif;"><h6>ABOUT US</h6></a>
          </li>

          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="contact.html" style="color: white;font-family: 'Verdana', sans-serif;"><h6>CONTACT</h6></a>
          </li>
        </ul>
      </div>
    </div>
    ...
    animation: mover 1s infinite alternate;">
      ...
      <div style="color: white;">
            <h4 style="font-family: 'Verdana', sans-serif;"> Ready to Login!</h4>
          </div>

         </div>

         <div class="col-md-4" style="margin-top: 5%;right: 8%">
          <div class="card" style="font-family: 'Verdana', sans-serif;">
            <div class="card-body">
              <center>
                <i class="fa fa-user fa-3x" aria-hidden="true" style="color:#0062cc"></i>
                <br>
